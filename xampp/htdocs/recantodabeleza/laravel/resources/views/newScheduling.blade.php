...
<script src='{{url("assets/js/scheduling.js")}}'></script>
		...
		<div class='container'>
			<div class='row justify-content-center'>
                ...
                @if(isset($scd)) 
					...
					@method('PUT')
                @else
                    <form class='contact-form' name='cadastro' id='cadastro' method='post' action="{{url('adm/scheduling')}}">
                @endif
                        @csrf
                        <div class='row'>
   ...
   @endif
    ...
    $(document).ready(function(){
        ...
        //PREENCHER INPUTS
		if (document.referrer == 'http://localhost/recantodabeleza/laravel/public/adm/scheduling/create'){
