...
<section class='contact-section'>
		...
		<div class='modal-dialog' role='document'>
			<div class='modal-content'>
				...
				<div class='modal-footer'>
					...
					<a href='{{url("adm/employeeType")}}' class='site-btn' id='white' name='confirmar'>Sim</a>
				</div>
			</div>
		</div>
	...
	<script>
		window.confirmarCancelar = function(){
            if(verificarCampos()){
                ...
                $('confirmar').on('click', function(){
                    window.location.href= '{{url("/adm/employeeType")}}';
                });
            } else {
                window.location.href= '{{url("/adm/employeeType")}}';
            }  
        ...
        function verificarCampos(){
			if ($('#nomeFuncao').val() == '' || $('#nomeFuncao').val() == null && 
				$('#salarioBase').val() == '' || $('#salarioBase').val() == null )
            {
                return false;
            }
            return true;
