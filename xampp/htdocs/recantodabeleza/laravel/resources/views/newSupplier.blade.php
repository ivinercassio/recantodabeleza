...
<section class='contact-section'>
							...
							@if(isset($rel))
									...
									<script type='text/javascript'>
										function createFields(product) {
												...
												$('<img>').attr({class: 'removeFromTable', src: 'http://localhost/recantodabeleza/laravel/public/img/icons/deleteproduct.png'}).click(removeItem).appendTo(div);
												div.appendTo(row);
	...
	<script> 
		...
		if (document.referrer == 'http://localhost/recantodabeleza/laravel/public/adm/supplier/create'){
