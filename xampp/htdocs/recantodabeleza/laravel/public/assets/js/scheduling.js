...
//verifica se os dois selects estão preenchidos
  ...
  function updateTotalValue(){
    ...
    var totalFormatado = total.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }); // formatacao: R$9,99
  
    document.getElementById('total').value = totalFormatado.slice(3, totalFormatado.length); // tira o 'R$' e exibe
  }
